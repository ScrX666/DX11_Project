...
)
{
	...
	std::string meshPath = "\\Content\\Models\\Animations\\AnimationTest.fbx";
	const aiScene* pScene = importer.ReadFile(meshPath.c_str(), aiProcess_Triangulate );
	...
	for (int i = 0; i < boneArray.size(); i++)
	{
		...
		XMMATRIX preRotation, translation, rotation, scaling;
	...
	if (pScene->HasAnimations())
	{
		...
		for (int CI = 0; CI < animationChannles.size(); CI++)
		{
			...
			//�������ͨ��������_$AssimpFbx$_����ô���������Transform��rotation��sacaleֻ��һ��Frames�������������
			if (gSHepler.IsContain(channleName, "_$AssimpFbx$_"))
			{
				//�Ѷ��������ֲ�⿪���������������һ����XXX__$AssimpFbx$_Transform֮��ģ�ǰ���Ƕ�����������֣������ǹ�������������ݵ�ͨ��
...
void SkeletonMeshComponent::LoadSkinnedModel(
	Microsoft::WRL::ComPtr<ID3D11Device>& md3dDevice,
	Microsoft::WRL::ComPtr<ID3D11GraphicsCommandList>& mCommandList
)
{
