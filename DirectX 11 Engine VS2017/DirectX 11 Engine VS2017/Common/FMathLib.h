//-------------------------------------------------------------------------------------
// FMathLib.h -- Simplified C++ Math wrapper for DirectXMath
//
...
//------------------------------------------------------------------------------
// Support for FMathLib and Standard C++ Library containers
namespace std
{

    template<> struct less<DirectX::FMathLib::Rectangle>
    {
        bool operator()(const DirectX::FMathLib::Rectangle& r1, const DirectX::FMathLib::Rectangle& r2) const noexcept
        {
            return ((r1.x < r2.x)
                || ((r1.x == r2.x) && (r1.y < r2.y))
    ...
    template<> struct less<DirectX::FMathLib::Vector2>
    {
        bool operator()(const DirectX::FMathLib::Vector2& V1, const DirectX::FMathLib::Vector2& V2) const noexcept
        {
            return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
        }
    };

    template<> struct less<DirectX::FMathLib::Vector3>
    {
        bool operator()(const DirectX::FMathLib::Vector3& V1, const DirectX::FMathLib::Vector3& V2) const noexcept
        {
            return ((V1.x < V2.x)
                || ((V1.x == V2.x) && (V1.y < V2.y))
    ...
    template<> struct less<DirectX::FMathLib::Vector4>
    {
        bool operator()(const DirectX::FMathLib::Vector4& V1, const DirectX::FMathLib::Vector4& V2) const noexcept
        {
            return ((V1.x < V2.x)
                || ((V1.x == V2.x) && (V1.y < V2.y))
                || ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
    ...
    template<> struct less<DirectX::FMathLib::Matrix>
    {
        bool operator()(const DirectX::FMathLib::Matrix& M1, const DirectX::FMathLib::Matrix& M2) const noexcept
        {
    ...
    template<> struct less<DirectX::FMathLib::Plane>
    {
        bool operator()(const DirectX::FMathLib::Plane& P1, const DirectX::FMathLib::Plane& P2) const noexcept
        {
            return ((P1.x < P2.x)
                || ((P1.x == P2.x) && (P1.y < P2.y))
    ...
    template<> struct less<DirectX::FMathLib::Quaternion>
    {
        bool operator()(const DirectX::FMathLib::Quaternion& Q1, const DirectX::FMathLib::Quaternion& Q2) const noexcept
        {
            return ((Q1.x < Q2.x)
                || ((Q1.x == Q2.x) && (Q1.y < Q2.y))
    ...
    template<> struct less<DirectX::FMathLib::Color>
    {
        bool operator()(const DirectX::FMathLib::Color& C1, const DirectX::FMathLib::Color& C2) const noexcept
        {
            return ((C1.x < C2.x)
                || ((C1.x == C2.x) && (C1.y < C2.y))
    ...
    template<> struct less<DirectX::FMathLib::Ray>
    {
        bool operator()(const DirectX::FMathLib::Ray& R1, const DirectX::FMathLib::Ray& R2) const noexcept
        {
    ...
    template<> struct less<DirectX::FMathLib::Viewport>
    {
        bool operator()(const DirectX::FMathLib::Viewport& vp1, const DirectX::FMathLib::Viewport& vp2) const noexcept
        {
