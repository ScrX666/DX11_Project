...
bool M3DLoader::LoadM3d(const std::string& filename,
	std::vector<VT::PosNormalTexTan>& vertices,
...
void M3DLoader::ReadVertices(std::ifstream& fin, UINT numVertices, std::vector<VT::PosNormalTexTan>& vertices)
{
	std::string ignore;
...
void M3DLoader::ReadSkinnedVertices(std::ifstream& fin, UINT numVertices, std::vector<VT::PosNormalTexTanSkinned>& vertices)
{
	std::string ignore;
	vertices.resize(numVertices);
